...
# process batch result from YOLO
"""
...
# process single result form YOLO
"""
...
# metaPath="./darknet/cfg/kf_coco.data") detect_result_str: str = str(detect_result) parsed_result: [] =
# parse_yolo_output(detect_result_str) change_obejct_name_to_index(parsed_result) result_array =
# observation_to_nparray(parsed_result)  # convert the result to a numpy array
